...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <td><div class="button-group"> <a class="button border-main" href="index.php?c=demo&m=update&id=<?php echo $v['id']; ?>"><span class="icon-edit"></span> 修改</a> <a id="dellink" class="button border-red dellink" href="index.php?c=demo&m=dodel&id=<?php echo $v['id']; ?>"><span class="icon-trash-o"></span> 删除</a></div></td>
      </tr>
		<?php }?>
      <tr>
        ...
        <a href="index.php?c=demo&m=add" style="padding:5px 15px; margin:0 10px;" class="button border-blue icon-edit" > 添加</a>
        </td>
      </tr>
    </table>
  </div>
