	...
	if($.validator != null) {
		...
		$.validator.setDefaults({
			...
			errorPlacement: function(error, element) {
				var fieldSet = element.siblings("span.fieldSet");
				if (fieldSet.size() > 0) {
...
if(typeof(KindEditor) != "undefined") {
	KindEditor.ready(function(K) {
		editor = K.create("#editor", {
			...
			filePostName: "file",
			fileManagerJson: BASE + "/resources/plugins/kindeditor/php/file_manager_json.php",
			uploadJson: BASE + "resources/plugins/kindeditor/php/upload_json.php",
