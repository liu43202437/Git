      ...
      if( this.bindData(this.peoData,reqData)){
        ...
        .then(res=>{
          if (res.status.succeed === 1) {
            ...
            //   Router.navigateWithSid('/resources/app/vc-bank.html', {name:escape(reqData.name),refuse:_vue.refuse});
            // } else {
            //   Router.navigateWithSid('/resources/app/question.7.html',{});
            // }
            switch (reqData.area_id) {
              case '14': Router.navigateWithSid('/resources/app/vc-bank.html', {name:escape(reqData.name),refuse:_vue.refuse,code: '14'});break;
              default: Router.navigateWithSid('/resources/app/vc-bank.html',{name:escape(reqData.name),refuse:_vue.refuse,code: '7'});break;
            }
          } else {
            swal({
              button: '关闭',
