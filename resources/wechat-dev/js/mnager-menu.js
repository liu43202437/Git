$(function(window){
    ...
    var html =`
        <div class="d-flex justify-content-around align-items-center">
          <div class="menue-item text-center point" data-url="/resources/wechat/manager-point.html" onclick="navigateTo('/resources/wechat/manager-point.html')">
            <div class="menue-icon"><i class="iconfont icon-indent f-40"></i></div>
            <div class="nenue-text">公益分</div>
          </div>
          <div class="menue-item text-center stamp relative" data-url="/resources/wechat/about-manager.html" onclick="navigateTo('/resources/wechat/manager-review.html')">
          ...
          <div class="menue-item text-center me" data-url="/resources/wechat/about-manager.html" onclick="navigateTo('/resources/wechat/managerinfo.html')">
