  ...
  data() {
    return {
      ...
      tabs: [{
        icon: 'icon-indent',
        label: '公益分',
        url: '/resources/wechat/area-manager-point.html'
      },
      {
        icon: 'icon-stamp',
        label: '审核',
        badge: '',
        url: '/resources/wechat/area-manager-review.html'
      },
      {
        icon: 'icon-me',
        label: '我的',
        url: '/resources/wechat/area-about.html'
      }]
    }
  },
  template: `
