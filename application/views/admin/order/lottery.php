...
<div class="content-wrapper">
    <div class="title-bar">彩票统计</div>
    <div class="list-wrapper">
        <form id="listForm" class="form-inline" action="lottery" method="get">
            <div class="filter-bar">
                <div>
                    <div class="form-group m-l-sm">
                        ...
                        <input type="text" class="form-control m-l-sm" name="selectKeyword" id="selectKeyword" value="<?= $selectKeyword?>" placeholder="彩票名">
                        <div class="form-group m-l-sm">
                            区域:&nbsp;
            ...
            <table id="listTable" class="list table">
                <tr>
                    <th class="check">&nbsp;</th>
                    <th class="">
                        <a href="javascript:;" class="sort" name="title">票名</a>
                    </th>
                    <th class="">
                        <a href="javascript:;" class="sort" name="count_price">单价</a>
                    </th>
                    <th class="">
                        <a href="javascript:;" class="sort" name="ticket_num">出售量</a>
                    </th>
                    <th class="">
                        <a href="javascript:;" class="sort" name="ticke_money">金额</a>
                    </th>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editRankForm3" action="exportlottery" class="form-horizontal" method="post">
                    <div>
                        <h4>导出需要一些时间,确认导出？</h4>
                    </div>
