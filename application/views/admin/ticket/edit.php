...
<body>
	<div class="content-wrapper">
		...
		<div class="input-wrapper">
			<form id="inputForm" action="do_edit" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="title" class="form-control" value="<?= $itemInfo['title']?>"/>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="tel" name="price" class="form-control" value="<?= $itemInfo['price']?>"/>
					</div>
					<div class="col-sm-offset-3 col-md-offset-2 col-sm-9 col-md-10 value-tip">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="tel" name="count_price" class="form-control" value="<?= $itemInfo['count_price']?>"/>
					</div>
					<div class="col-sm-offset-3 col-md-offset-2 col-sm-9 col-md-10 value-tip">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="size" class="form-control" value="<?=$itemInfo['size']?>" placeholder="尺寸（英寸）"/>
					</div>
					<div class="col-sm-offset-3 col-md-offset-2 col-sm-9 col-md-10 value-tip">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="land" class="form-control" value="<?=$itemInfo['land']?>" placeholder="厚度（毫米）"/>
					</div>
					<div class="col-sm-offset-3 col-md-offset-2 col-sm-9 col-md-10 value-tip">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="tel" name="inventory" class="form-control" value="<?= $itemInfo['inventory']?>"/>
					</div>
					<div class="col-sm-offset-3 col-md-offset-2 col-sm-9 col-md-10 value-tip">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						...
						<option value='0' <?php if($itemInfo['status'] == 0): ?> selected="selected" <?php endif; ?> >正常<optione>
						<option value='1' <?php if($itemInfo['status'] == 1): ?> selected="selected" <?php endif; ?> >禁止<optione>
						</select>
					</div>
					<div class="col-sm-offset-3 col-md-offset-2 col-sm-9 col-md-10 value-tip">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="create_date" class="form-control" value="<?= $itemInfo['create_date']?>"/>
					</div>
				</div>				
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-md-6">
						<textarea class="hidden" name="description"><?= $itemInfo['description'] ?></textarea>
						<div id="summernote"><?= $itemInfo['description'] ?></div>
					</div>
				</div>
				<hr/>
