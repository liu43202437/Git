    ...
    <div class="list-wrapper">
        <form id="listForm" class="form-inline" action="more" method="get">
            <div class="filter-bar">
               ...
               <input type="text" class="form-control m-l-sm" name="notes" id="notes" value="<?= $notes ?>"
               placeholder="备注">
            ...
            <table id="listTable" class="list table">
                <tr>
                    ...
                    <th class="name">
                        <a href="javascript:;" name="view_name">收据备注</a>
                    </th>
                    <th class="phone">
                        <a href="javascript:;">收据照片</a>
                    </th>
                    <th class="phone">
                ...
                <?php foreach ($itemList as $item): ?>
                    <tr>
                        ...
                        <td>
                            <?php foreach($item['receipt_image']['receipt_image'] as $value):  ?>
                        ...
                        <td class="operation">
                            <?php if ($isEditable): ?>
                                <?php if (1 == 1): ?>
                                    <span>
                                        <a href="receipt_edit?id=<?= $item['id'] ?>" title="详情"><i class="fa fa-align-justify"></i></a>
                                    </span>
                                <?php endif; ?>
