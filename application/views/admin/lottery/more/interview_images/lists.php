                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach($item['images'] as $value):  ?>
                                <img src="<?= $value ?>" height="100px" width="100px"  alt="打卡照片"  />
                                &nbsp;&nbsp;
                            <?php endforeach;?>
                        </td>
                        <td>
                        ...
                        <td class="operation">
                            <?php if ($isEditable): ?>
                                <?php if (1 == 1): ?>
                                    <span>
                                        <a href="interview_images_edit?id=<?= $item['id'] ?>" title="详情"><i class="fa fa-align-justify"></i></a>
                                    </span>
                                <?php endif; ?>
