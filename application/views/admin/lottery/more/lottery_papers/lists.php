    ...
    <div class="list-wrapper">
        <form id="listForm" class="form-inline" action="more" method="get">
            <div class="filter-bar">
               ...
               <input type="text" class="form-control m-l-sm" name="lottery_papers" id="lottery_papers" value="<?= $lottery_papers ?>"
                       placeholder="代销证号">
               <input type="text" class="form-control m-l-sm" name="name" id="name" value="<?= $name ?>"
               placeholder="店主姓名">
               <input type="text" class="form-control m-l-sm" name="phone" id="phone" value="<?= $phone ?>"
               placeholder="店主手机">
            ...
            <table id="listTable" class="list table">
                <tr>
                    ...
                    <th class="address">
                        <a href="javascript:;">代销证号</a>
                    </th>
                    <th class="address">
                        <a href="javascript:;">代销证照片</a>
                    </th>
                    <th class="time">
                ...
                <?php foreach ($itemList as $item): ?>
                    <tr>
                        ...
                        <td>
                            <img src="<?= $item['lottery_papers_image'] ?>" height="100px" width="100px"  alt="代销证照片"  />
                        </td>
                        <td>
                            <?= $item['create_date'] ?>
                        </td>
                        <td class="operation">
                            <?php if ($isEditable): ?>
                                <?php if (1 == 1): ?>
                                    <span>
                                        <a href="lottery_papers_edit?id=<?= $item['id'] ?>" title="详情"><i class="fa fa-align-justify"></i></a>
                                    </span>
                                <?php endif; ?>
