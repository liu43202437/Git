			...
			<form id="listForm" class="form-inline" action="lists" method="get">
				<div class="filter-bar">
					<div>
		                ...
		                <button class="btn btn-white m-l-sm" type="submit">筛 选</button>
				...
				<table id="listTable" class="list table">
					<tr>
						...
						<!-- <th>
							<a href="javascript:;" class="sort" name="username">手机号码</a>
						</th> -->
						<th>
					...
					<?php foreach ($itemList as $item): ?>
						<tr>
							...
							<td class="operation">
								...
								<a class="deleteItemBtn2" data-url="delete" data-id="<?= $item['id'] ?>" title="删除"><i
			...
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<form id="addPointForm" action="add_point" class="form-horizontal" method="post">
						...
						<div class="form-group">
							<label class="control-label col-xs-5 fa fa-trash-o">删除：</label>
							<div class="col-xs-7">
