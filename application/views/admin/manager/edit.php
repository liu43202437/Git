			...
			<form id="inputForm" action="do_edit" method="post" class="form-horizontal">
                ...
                <label class="col-sm-3 col-md-2 control-label required">
                 ...
                 <div class="col-sm-6 col-md-4" style="display: flex">
                    ...
                    <!-- <input class="hidden-input" name="address" id='address' type="text" value=""> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="area_managername" class="form-control" value="<?= $itemInfo['area_managername']?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 col-md-2 control-label">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="area_managerid" class="form-control" value="<?= $itemInfo['area_managerid']?>"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="create_date" readonly="readonly" class="form-control" value="<?= $itemInfo['create_date']?>"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-md-6">
						<textarea class="hidden" name="intro"><?= $itemInfo['intro'] ?></textarea>
						<div id="summernote"><?= $itemInfo['intro'] ?></div>
					</div>
				</div>
				<hr/>
				<!-- <div class="form-group">
