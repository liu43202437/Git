    ...
    <script type="text/javascript">
        $().ready(function () {
            ...
            $(".checkItemBtn").click(function(){
                ...
                var url = 'check';
                // var manager_id = prompt("请输入客户经理工作证号","");
            ...
            $("#exportManager").click(function() {
                ...
                $dlgEdit3.find(".modal-title").text("导出客户经理");
                $dlgEdit3.modal('show');
    ...
    <div class="title-bar">
        ...
        <?php if ($isEditable): ?>
           <!--  <div class="pull-right op-wrapper">
                <a href="edit"><i class="fa fa-plus"></i> 添加客户经理</a>
            </div> -->
        <?php endif; ?>
    </div>
        ...
        <form id="listForm" class="form-inline" action="lists" method="get">
            <div class="filter-bar">
                ...
                <div class="form-group m-l-sm">
                    ...
                    <option value="3" <?php if($type == 3):?> selected = "selected" <?php endif; ?> >已通过</option>
                    <option value="4" <?php if($type == 4):?> selected = "selected" <?php endif; ?> >已拒绝</option>
                </select>
                </div>
                <button class="btn btn-white m-l-sm" type="submit" id="filtrate">筛 选</button>
                <button class="btn btn-white m-l-sm" type="button" id="exportManager">导出客户经理</button>
            </div>
         ...
         <!--            <th class="image">
                    ...
                    <th>
                        <a href="javascript:;" class="sort" name="name">客户经理姓名</a>
                    </th>
                    <th>
                        <a href="javascript:;" name="avatar_url">头像</a>
                    </th>
                    <!-- <th class="name">
                    ...
                    <th class="manager_id">
                        <a href="javascript:;">市场经理</a>
                    </th>
                    <th class="manager_id">
                        <a href="javascript:;">市场经理手机</a>
                    </th>
                    <th class="time">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="dlgEdit3">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title">导出客户经理</h3>
                    </div>
                    <div class="modal-body">
                    <form id="editRankForm3" action="exportManager" class="form-horizontal" method="post">
                        <div>
                        <h4>导出需要一些时间,确认导出？</h4>
                        </div>
