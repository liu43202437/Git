		...
		<div class="input-wrapper">
			<form id="inputForm" action="do_edit" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
						<input type="text" name="manager_name" class="form-control" value="<?= $itemInfo['bazaar_name']?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 col-md-2 control-label">
					...
					<div class="col-sm-6 col-md-4">
						<input type="tel" name="manager_id" class="form-control" value="<?= $itemInfo['bazaar_phone']?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 col-md-2 control-label">
