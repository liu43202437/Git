    ...
    <script type="text/javascript">
        $().ready(function () {
            ...
            $(".checkItemBtn").click(function(){
                ...
                var url = 'check';
                // var manager_id = prompt("请输入市场经理工作证号","");
            ...
            $("#exportAreaManager").click(function() {
    ...
    <div class="title-bar">
        ...
        <?php if ($isEditable): ?>
            <!-- <div class="pull-right op-wrapper">
                <a href="edit"><i class="fa fa-plus"></i> 添加市场经理</a>
            </div> -->
        <?php endif; ?>
    </div>
    <div class="list-wrapper">
        <form id="listForm" class="form-inline" action="lists" method="get">
            <div class="filter-bar">
                ...
                <button class="btn btn-white m-l-sm" type="button" id="exportAreaManager">导出市场经理</button>
         ...
         <!--            <th class="image">
                    ...
                    <th>
                        <a href="javascript:;" class="sort" name="name">市场经理姓名</a>
                    </th>
                    <th>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="dlgEdit3">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title">导出市场经理</h3>
                    </div>
                    <div class="modal-body">
                    <form id="editRankForm3" action="exportAreaManager" class="form-horizontal" method="post">
                        <div>
                        <h4>导出需要一些时间,确认导出？</h4>
                        </div>
