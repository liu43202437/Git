    ...
    <div class="title-bar">
        ...
        <?php if ($isEditable): ?>
            <div class="pull-right op-wrapper">
                <a href="addClub"><i class="fa fa-plus"></i> 添加零售店</a>
            </div>
        <?php endif; ?>
    </div>
            ...
            <div class="filter-bar">
               ...
               <div class="form-group m-l-sm">
                ...
                <select class="form-control s-lg" name="type" id="type">
                            <option value="5" <?php if($type == 5):?> selected = "selected" <?php endif; ?> >全部</option>
                            <option value="0" <?php if($type == 0):?> selected = "selected" <?php endif; ?> >未审核</option>
                            <option value="2" <?php if($type == 2):?> selected = "selected" <?php endif; ?> >通过客户经理审核</option>
                            <option value="1" <?php if($type == 1):?> selected = "selected" <?php endif; ?> >通过审核</option>
                            <option value="3" <?php if($type == 3):?> selected = "selected" <?php endif; ?> >已下单</option>
                            <option value="4" <?php if($type == 4):?> selected = "selected" <?php endif; ?> >已付款</option>
                        </select>
                </div>
            ...
            <table id="listTable" class="list table">
                ...
                <?php foreach ($itemList as $item): ?>
                    <tr>
                        ...
                        <td>
                            <a class="fancybox" href="<?= $item['avatar'] ?>"
                               title="用户头像">
