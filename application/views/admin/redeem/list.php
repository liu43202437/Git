    ...
    <div class="title-bar">
        ...
        <!-- <?php if ($isEditable): ?>
            <div class="pull-right op-wrapper">
                <a href="addClub"><i class="fa fa-plus"></i> 添加兑奖管理</a>
            </div>
        <?php endif; ?> -->
    </div>
    <div class="list-wrapper">
        <form id="listForm" class="form-inline" action="redeemLists" method="post">
            <div class="filter-bar">
                ...
                <input type="text" class="form-control m-l-sm" name="search_key" id="search_key" value="<?= $searchKey ?>"
                       placeholder="用户ID、站点号、保安码、票号、票种、价格">
               ...
               <div class="form-group m-l-sm">
                ...
                <button class="btn btn-white m-l-sm" type="button" id="exportClub">导出数据</button>
            </div>
            ...
            <table id="listTable" class="list table">
                <tr>
                    ...
                    <th class="manager_id">
                        <a href="javascript:;">保安码</a>
                    </th>
                    <th class="phone">
                        <a href="javascript:;">票号</a>
                    </th>
                    <th class="phone">
                        <a href="javascript:;">票种</a>
                    </th>
                    <th class="phone">
                        <a href="javascript:;" class="sort" name="prize">中奖金额</a>
                    </th>
                    <th class="phone">
                        <a href="javascript:;" class="sort" name="time">兑奖时间</a>
                    </th>
                </tr>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="dlgEdit3">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <form id="editRankForm3" action="exportRedeem" class="form-horizontal" method="post">
                        <div>
                        <h4>导出需要一些时间,确认导出？</h4>
                        </div>
