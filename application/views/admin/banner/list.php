	...
	<div class="content-wrapper">
		<div class="title-bar">
			...
			<div class="pull-right op-wrapper">
				<a href="edit?kind=<?= BANNER_MAIN ?>"><i class="fa fa-plus"></i> 添加Banner</a>
			</div>
			<?php endif; ?>
		</div>
		<div class="list-wrapper">
			<form id="listForm" class="form-inline" action="change_order" method="post">
						...
						<tr class="item">
							...
							<td>
								...
								<a class="fancybox" href="<?= getFullUrl($item['image']) ?>" title="<?= $item['title'] ?>">
									<img src="<?= getFullUrl($item['image']) ?>" width="150" height="75">
								</a>
							</td>
							<td>
								<?= $item['title'] ?>
