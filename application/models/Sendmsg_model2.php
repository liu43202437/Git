...
class Sendmsg_model2 extends CI_Model
{
    private $memcache = '';
    private $token = '';
    ...
    public function passShop($openid = '',$name,$phone){
        ...
        $data=[
            ...
            'topcolor'=>"#FF0000",
            'data'=>array(
                'first'=>array('value'=>'您的店铺审核通过',"color"=>"#173177"),
                'keyword1'=>array('value'=>$name,"color"=>"#173177"),
    ...
    public function passManager($openid = ''){
        ...
        $data=[
            ...
            'topcolor'=>"#FF0000",
            'data'=>array(
                'first'=>array('value'=>'您的客户经理审核通过',"color"=>"#173177"),
    ...
    public function tongzhi($openid = ''){
        ...
        $data=[
            'touser'=>$openid,
            'template_id'=>'bujDde64OxVAifgf_tq79N6_jqNt9rU815koCp3_pCM',
            // 'url'=>base_url().'mobile/pointmall?appId=31',
            'topcolor'=>"#FF0000",
            'data'=>array(
                'first'=>array('value'=>'零售户老板们，你们好！

15-17号，中维公司会组织安排工作人员上门给各位零售户做以下服务：
1. 颁发省福彩中心公益票代销证
2. 签代销协议，请大家准备好身份证复印件
3. 配送兑奖终端设备，并有工作人员教大家使用
4. 请大家进行“在线申领公益票”，第一次配票由我们工作人员在颁发代销证时统一配送，后续送票通过顺丰物流配送                                                                                                                                                     a. 配送金额3000元                                                                                                                         b.  配送票种如下 ：                                                                                                                                            美梦成真 2包                                                                                                                                富贵有余1包                                                                                                                                  争分夺秒2包                                                                                                                                 蓝玫瑰 2包                                                                                                                                    北京印象2包                                                                                                                                             c.第一次配送的3000元票，你们无需付款，再次购票时通过“北京中维” 微信公众平台领票， 第二次配票时支付上一订单货款，并返还7个点销售佣
5. 配送室内，室外灯箱，展示柜／展示盒 
6. 工作人员会进行一个简单的售前培训，有问题可以扫描工作人员出示的二维码进入“北京中维公益票交流群”',"color"=>"#173177"),
                'keyword1'=>array('value'=>'零售户审核通知更正',"color"=>"#173177"),
                'keyword2'=>array('value'=>'你的零售户申请待审核',"color"=>"#173177"),
                'keyword3'=>array('value'=>date('Y-m-d H:i:s'),"color"=>"#173177"),
                // 'remark'=>array('value'=>'请耐心等待我们的通知，下一期的零售户名单里就有你。',"color"=>"#173177")
            )
        ];
